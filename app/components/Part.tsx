...
export default function Part(props: PartProps) {
  return (
    <div className="bg-gray-200 min-w-full height-14 shadow-md shadow-gray-600 p-2 rounded-xl ring-1 ring-slate-600 flex h-32 items-center gap-4">
      <img className="rounded-xl h-full object-cover w-40" src={props.src} alt="" />
      ...
      <div className="flex  gap-2  flex-col flex-nowrap overflow-y-auto overflow-x-hidden h-full">
        <div className="flex gap-2 w-full flex-1">
          ...
          <p className="text-xl font-bold">${props.price || "000"}</p>
          <p className="text-xl font-med self-end">{props.model || "modelname"}</p>
        </div>
